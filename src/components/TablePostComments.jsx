...
export default function TablePostComments({data}) {
  ...
  return (
    <TableContainer sx={{maxWidth:1200,marginLeft:"auto",marginRight:"auto",backgroundColor:"transparent",backdropFilter:"blur(30px)",borderTop:"solid 1px #f2f2f2;"}} component={Paper}>
      ...
      <Table sx={{ minWidth: 650 }} aria-label="simple table">
        ...
        <TableBody>
          {data.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((comment,idx) => (
            <TableRow
              key={idx}
